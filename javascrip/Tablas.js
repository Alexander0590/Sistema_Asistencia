        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(function (personal, index) {
                    ...
                    let btneditar = `<button  class="btn btn-primary perEditar" data-id="${personal.iddni}">
                            <i class="bi bi-pencil"></i>
                        </button>`;
                    let btneliminar = `<button  class="btn btn-danger perEliminar" data-id="${personal.iddni}">
                            <i class="bi bi-trash"></i>
                        </button>`;
                    let btnimpre=`<button  class="btn btn-dark perImpri" data-id="${personal.iddni}">
                           <i class="bi bi-printer"></i>
                        </button>`;


                    if (personal.estado === "inactivo") {
                        btnimpre =`<button  class="btn btn-dark perImpri" data-id="${personal.iddni}" disabled>
                        <i class="bi bi-printer"></i>
                        </button>`;
                    }
